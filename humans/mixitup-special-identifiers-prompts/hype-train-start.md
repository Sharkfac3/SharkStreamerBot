...
Update `Actions/Twitch Hype Train/hype-train-start.cs` so its Mix It Up payload sends populated `SpecialIdentifiers` instead of an empty object.
...
Do not use dots in Mix It Up identifier names even though some Streamer.bot args contain dots.
