...
Target script: `Actions/Twitch Bits Integrations/bits-tier-4.cs`
...
Update `Actions/Twitch Bits Integrations/bits-tier-4.cs` so its Mix It Up payload sends populated `SpecialIdentifiers` instead of an empty object.
