...
Your focused task:
Resolve the ambiguity around how the runtime stores rosters, votes, branch history, and recovery snapshots.

Specifically investigate:
- whether these values should be stored as JSON strings in globals, multiple discrete globals, or another structure
- how the storage shape affects operator recovery, debugging, and future implementation simplicity
- how vote replacement, roster inspection, and branch history should be represented
- what minimum storage contract is needed before engine implementation begins
- whether the storage format should be documented as canonical or left as an implementation detail

Questions you should be ready to ask me may include:
- How important is human readability of stored state?
- Do we want minimal globals or more explicit separate vars?
- Should recovery snapshots be append-only history or just latest state?
- How much future tooling support should this shape anticipate?

Do not write storage docs or constants until I answer your questions.
