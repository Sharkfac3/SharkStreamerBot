# Prompt: Thin comments in `Actions/Commanders/The Director/the-director-secondary.cs`
...
Task:
Thin the comments in `Actions/Commanders/The Director/the-director-secondary.cs` so the script does not duplicate behavior already described in `Actions/Commanders/The Director/README.md`. The behavior docs are the source of truth; the script should reference them instead of restating long narrative explanations.
...
3. Edit only `Actions/Commanders/The Director/the-director-secondary.cs` unless you discover the behavior reference is missing or materially wrong.
...
- List paste target: `Actions/Commanders/The Director/the-director-secondary.cs`.
