...
public class CPHInline
{
    ...
    public bool Execute()
    {
        const string logPrefix = "Rest Focus Focus End";
        ...
        TriggerMixItUpCommand(MIXITUP_FOCUS_TIMER_END_COMMAND_ID, logPrefix);

        if (!StartTargetTimer(TIMER_PRE_REST, PRE_REST_SECONDS, logPrefix, PHASE_PRE_REST))
        {
