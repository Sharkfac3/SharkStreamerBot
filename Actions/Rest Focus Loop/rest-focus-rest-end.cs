...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        {
            CPH.LogWarn($"[Rest Focus Rest End] Ignoring stale timer fire because phase is '{currentPhase}'.");
            return true;
        }

        CPH.DisableTimer(TIMER_REST);
        TriggerMixItUpCommand(MIXITUP_CAPTAINS_FOCUS_WARNING_COMMAND_ID, "Rest Focus Rest End");

        StartTimer(TIMER_PRE_FOCUS, PRE_FOCUS_SECONDS, "Rest Focus Rest End");
