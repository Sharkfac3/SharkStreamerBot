// ACTION-CONTRACT: Actions/Voice Commands/contracts.md#scene-chat.cs
// ACTION-CONTRACT-SHA256: 8d05983f3430ea592d2b1240f62416e7523da71d63c7a22ac78b7a8638d8f186
...
public class CPHInline
{
    ...
    private const string SCENE_SECTION_LABEL = "Chat";
    ...
    /*
     * Purpose:
     * - Switches OBS to the Chat scene for the current stream mode.
     *
    ...
    public bool Execute()
    {
        ...
        {
            CPH.LogWarn("[Voice Commands: Scene Chat] Could not resolve a target scene.");
            return true;
        }
    ...
    private string ResolveTargetScene(string mode)
    {
        switch (mode)
        {
            ...
            default:
                CPH.LogWarn($"[Voice Commands: Scene Chat] Unknown stream_mode '{mode}'. Falling back to workspace scene.");
                return BuildSceneName(SCENE_PREFIX_WORKSPACE);
        }
    }
