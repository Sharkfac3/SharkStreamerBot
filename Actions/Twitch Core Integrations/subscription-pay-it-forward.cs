...
public class CPHInline
{
    /*
     * Purpose:
     * - Base Twitch integration bridge for a Pay It Forward event.
     * - Fires when a user who received a gifted sub pays it forward by gifting to someone else.
     *
     * Expected trigger/input:
     * - Wire this script to the Streamer.bot Twitch event: Subscriptions → Pay It Forward.
     *
     ...
     * - user   (string) : Display name of the user paying it forward (from Twitch User group)
