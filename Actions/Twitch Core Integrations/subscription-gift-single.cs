...
public class CPHInline
{
    /*
     * Purpose:
     * - Base Twitch integration bridge for a single gifted subscription event.
     *
     * Expected trigger/input:
     * - Wire this script to the Streamer.bot Twitch event for exactly 1 gifted sub.
    ...
    private const string SCRIPT_NAME = "Core - Subscription Gift Single";
    private const string MIXITUP_BASE_URL = "http://localhost:8911";
    private const string MIXITUP_PLATFORM_TWITCH = "Twitch";
    private const string MIXITUP_COMMAND_ID = "REPLACE_WITH_CORE_SUBSCRIPTION_GIFT_SINGLE_COMMAND_ID";
