...
public class CPHInline
{
    /*
     * Purpose:
     * - Base Twitch integration bridge for a Prime Paid Upgrade event.
     * - Fires when a user upgrades their Twitch Prime subscription to a paid tier.
     *
     * Expected trigger/input:
     * - Wire this script to the Streamer.bot Twitch event: Subscriptions → Prime Paid Upgrade.
     *
     ...
     * - systemMessage  (string)  : Twitch chat system message for this event
     * - upgradeTier    (number)  : Numeric tier of the upgrade (e.g. 1000 for Tier 1)
     * - upgradeTierString (string): Text tier name (e.g. "tier 1")
     * - user           (string)  : Display name of the upgrading user (from Twitch User group)
    ...
    private string BuildArguments()
    {
        ...
        // Available args: systemMessage, upgradeTier, upgradeTierString, user, userId.
        return string.Empty;
    }
