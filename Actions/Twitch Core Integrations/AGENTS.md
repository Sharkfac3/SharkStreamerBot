...
- [Actions/constants/stream-core.md](../constants/stream-core.md), [Actions/constants/mini-games.md](../constants/mini-games.md), [Actions/constants/overlay-broker.md](../constants/overlay-broker.md), [Actions/constants/lotat.md](../constants/lotat.md), and [Actions/constants/effects.md](../constants/effects.md) for canonical `stream-start.cs` reset domains.
...
- Any new global variable added by any feature must be added to `stream-start.cs` reset logic and documented in the relevant file under `Actions/constants/` (use `Actions/SHARED-CONSTANTS.md` as the index).
