...
public class CPHInline
{
    /*
     * Purpose:
     * - Base Twitch integration bridge for a multi-gift subscription event.
     *
     * Expected trigger/input:
     * - Wire this script to the Streamer.bot Twitch event for more than 1 gifted sub.
    ...
    private const string SCRIPT_NAME = "Core - Subscription Gift Multiple";
    private const string MIXITUP_BASE_URL = "http://localhost:8911";
    private const string MIXITUP_PLATFORM_TWITCH = "Twitch";
    private const string MIXITUP_COMMAND_ID = "REPLACE_WITH_CORE_SUBSCRIPTION_GIFT_MULTIPLE_COMMAND_ID";
