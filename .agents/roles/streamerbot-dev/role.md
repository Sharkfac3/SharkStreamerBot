...
- Runtime source-of-truth action contracts in local Actions `AGENTS.md` files.
...
- Runtime use of [Actions/SHARED-CONSTANTS.md](../../../Actions/SHARED-CONSTANTS.md) and [Actions/Helpers/AGENTS.md](../../../Actions/Helpers/AGENTS.md).
- `ACTION-CONTRACT` stamps generated by [Tools/StreamerBot/Validation/action_contracts.py](../../../Tools/StreamerBot/Validation/action_contracts.py).
...
Then check [Actions/Helpers/AGENTS.md](../../../Actions/Helpers/AGENTS.md) for reusable C# patterns.
