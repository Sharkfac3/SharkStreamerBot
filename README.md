...
- **agent knowledge tree** in `.agents/` (roles, workflows, shared context, routing)
...
- `.agents/` — shared agent knowledge tree (roles, workflows, shared context, routing). Agent-agnostic — used by all agents.
...
- `.agents/ENTRY.md` — agent entrypoint
